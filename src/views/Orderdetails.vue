<template>
  <div>
    ...
    <div class="mask" ref="mask" v-show="isPay">
      <!-- 二维码 -->
      <div class="erweima">
        <img v-show="alipay_erweima" src="../assets/cart_img/支付宝.png" alt />
        <img v-show="wechat_erweima" src="../assets/cart_img/微信.png" alt />
      </div>
      <!-- 支付页面 -->
      <div class="pay_shell">
        ...
        <div v-else class="pay_view">
          ...
          <div class="pay_router" @click="pay_router">如支付完成，尚未跳转请等待或点击此按钮</div>
        </div>
      </div>
      <!-- 支付页面 -->
    </div>
    <div class="all">
        ...
        <div class="details_main_content">
          ...
          <div>
            <div class="main_content_first">
              <div>{{item.title}}</div>
              <div class="main_content_first_price">
                <div class="float_right">￥{{item.price}}</div>
        ...
        <div class="goods_selection">
          ...
          <div>
            <div class="float_right subtotal">
              ...
              <span class="font_orange">￥{{item.price}}</span>
            </div>
            <!-- 解决高度坍塌 -->
      ...
      <div class="total">
        <div class="float_right">
          ...
          <button @click="submit_btn" class="submit_btn">提交订单</button>
        </div>
        <!-- 解决高度坍塌 -->
        <div class="solve_float_problem"></div>
      </div>
